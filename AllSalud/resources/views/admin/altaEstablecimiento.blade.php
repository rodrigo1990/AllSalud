...
<form action="/admin/createEstablecimiento" method="POST">
	...
	<div id="content" class="">
		...
		<div class="locacion">
			...
			<h1 class="margin-top-50">Servicios</h1>
			<div class="row">
				...
				<?php $k++; ?>
						<li id="tipo-li">
								<select name="establecimientos[establecimiento1][tipos][{{$k}}]" class="form-control" id="">
