...
class AjaxService
{
    ...
    public function buscarCiudadesAsignadasEstablecimientoSegunProvincia($request){
        ...
        return $this->ajaxDao->buscarCiudadesAsignadasEstablecimientoSegunProvincia($request);
    }
    ...
    public function buscarEstablecimientoPorTipoProvinciaCiudadEspecialidad(Request $request){
      ...
      return $this->ajaxDao->buscarEstablecimientoPorTipoProvinciaCiudadEspecialidad($request);
